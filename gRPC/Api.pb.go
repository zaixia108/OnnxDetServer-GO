...
type InitEngineRequest struct {
	...
	UseFp16       bool                   `protobuf:"varint,9,opt,name=use_fp16,json=useFp16,proto3" json:"use_fp16,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *InitEngineRequest) GetUseFp16() bool {
	if x != nil {
		return x.UseFp16
	}
	return false
...
const file_api_proto_rawDesc = "" +
	...
	"\x06center\x18\x04 \x01(\v2\x0f.proto.PositionR\x06center\"\xf1\x01\n" +
	...
	"\buse_fp16\x18\t \x01(\bR\auseFp16\"X\n" +
